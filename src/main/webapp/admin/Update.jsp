        ...
        function submitData() {
            ...
            $.ajax({
                ...
                success: function (data, status) {
                    ...
                    $("#tag").val(data.tag);
                    $("#catalog").combobox("setValue",data.catalog.id);
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <input class="input-xlarge" type="text" placeholder="请输入标题"
                   style="width: 100%;height: 26px;margin-top: 10px" name="title" id="title" value="${title}">

            <input class="input-xlarge" type="text" placeholder="标签"
                   style="width: 45%;height: 26px;float: left;margin-top: 10px" name="tag" id="tag" value="${result.tag}">
           <div style="margin-top: 10px"><strong>请选择分类： </strong>  <select class="easyui-combobox" style="width: 150px; height: 25px; line-height: 50px;" id="catalog" editable="false">
            ...
            <div id="articlemd" style="margin-top: 10px">
                <textarea class="editormd-markdown-textarea" name="content" id="update"></textarea>
